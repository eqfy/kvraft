...
func (c *ClientLearnServers) GetLeaderNode(request kvslib.CCoordGetHeadServerArg, reply *kvslib.CCoordGetHeadServerReply) error {
	...
	*reply = kvslib.CCoordGetHeadServerReply{
		ServerId:     serverId,
